...
class Tic_Tac_Toe():
    ...
    def display_gameover(self):
        ...
        score_text += 'Player 2 (0) : ' + str(self.O_score) + '\n'
    ...
    def convert_grid_logical_position(self, grid_position):
    ...
    def click(self, event):
        ...
        logical_position = self.convert_grid_logical_position(grid_position)
